...
DEFAULT_CONFIG = {
    ...
    "tts": {
        ...
        "edge": {
            ...
            "speed": 1.25,
            # GB male: RyanNeural, ThomasNeural; US: AndrewNeural, BrianNeural; female: AriaNeural, SoniaNeural
        },
        "elevenlabs": {
    ...
    "delegation": {
        ...
        # ACP defaults for delegate_task children. By default children use
        # Claude Code (`claude --acp --stdio`), and when no explicit --model
        # is provided Hermes auto-selects a Claude model based on task
        # complexity (low/medium/high).
        "default_acp_command": "claude",
        "acp_auto_model_selection": True,
        "acp_complexity_model_map": {
            "low": "haiku",
            "medium": "sonnet",
            "high": "opus",
        },
