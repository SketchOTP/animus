...
def create_job(
    ...
    Args:
        ...
        schedule_tz: Optional IANA timezone name for wall-time cron UI (Hermes Chat);
                stored on the job; scheduler may still use process default tz until wired.
    ...
    if schedule_tz is None or schedule_tz == "":
        normalized_schedule_tz = None
    else:
        normalized_schedule_tz = str(schedule_tz).strip() or None
    ...
    job = {
        ...
        "schedule_tz": normalized_schedule_tz,
    }
